  ...
  return(
    <section className='flex flex-col md:flex-row items-center h-screen'>
        ...
        <div className='text-black px-8 py-16 lg:px-20 md:w-1/2 h-full flex flex-col justify-center'>
            ...
            <Link to='/our-stores' className='self-start text-xs font-bold text-[#333333] uppercase border-b-2 tracking-[2.5px] hover:text-accent-hover transition-colors duration-500 '>Saiba mais sobre as nossas lojas</Link>
        </div>
    </section>
  );
}
